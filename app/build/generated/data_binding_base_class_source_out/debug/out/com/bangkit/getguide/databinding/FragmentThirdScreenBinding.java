...
public final class FragmentThirdScreenBinding implements ViewBinding {
  ...
  private FragmentThirdScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageView, @NonNull Button nextButton, @NonNull TextView textView,
  ...
  public static FragmentThirdScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentThirdScreenBinding((ConstraintLayout) rootView, imageView, nextButton,
          textView, textView2);
    }
